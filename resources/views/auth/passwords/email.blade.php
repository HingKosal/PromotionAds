                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-8 col-md-8">
                                        <button type="submit" class="btn btn-danger btn-lg btn-block"><i class="ft-unlock"></i> Send Password Reset Link</button>
                                    </div>
                                    <div class="col-12 col-sm-4 col-md-4">
                                        <a href="{{route('user')}}" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i> Cancel</a>
